# Thorne Color Pallette

# Catppuccin Mocha
mocha_white='#dce0e8'
mocha_gray='#6e738d'
mocha_dark_gray='#313244'
mocha_light_purple='#cba6f7'
mocha_dark_purple='#b4befe'
mocha_cyan='#89dceb'
mocha_green='#a6e3a1'
mocha_orange='#fab387'
mocha_red='#f38ba8'
...
# Oxocarbon Dark
oxocarbon_white='#dde1e6'
oxocarbon_gray='#262626'
oxocarbon_dark_gray='#161616'
oxocarbon_light_purple='#be95ff'
oxocarbon_dark_purple='#393939'
oxocarbon_cyan='#3ddbd9'
oxocarbon_green='#33b1ff'
oxocarbon_orange='#78a9ff'
oxocarbon_red='#ee5396'
oxocarbon_pink='#ff7eb6'
oxocarbon_yellow='#42be65'
