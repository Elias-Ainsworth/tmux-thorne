...
# configuration
# @thorne-continuum-mode default (countdown|time|alert|interval)
# @thorne-continuum-time-threshold 15

alert_mode="@thorne-continuum-mode"
time_threshold="@thorne-continuum-time-threshold"
warn_threshold=360
first_save="@thorne-continuum-first-save"
