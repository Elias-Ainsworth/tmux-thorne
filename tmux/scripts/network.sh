...
network_interface=$(get_tmux_option "@thorne-network-bandwidth" "en0")
wifi_label=$(get_tmux_option "@thorne-network-wifi-label" "")
ethernet_label=$(get_tmux_option "@thorne-network-ethernet-label" "Ethernet")
